...
def setupDB():
    ...
    mycursor.execute("Create Table IF NOT EXISTS BookedTickets (bookingID INT Auto_Increment PRIMARY KEY UNIQUE, exponent INT, BigN INT, emailHash VARCHAR(255), nameHash VARCHAR(255), date VARCHAR(15))")
    mycursor.close()
